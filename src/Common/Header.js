...
const Header = () => {
    ...
    return (
        <div className='header-main-div d-flex justify-content-between align-items-center px-4 py-3 shadow border-bottom border-1'>
            <h3 className=''>Notes Sharing</h3>
            {
                admin ?
                    <ul className="header-menu-items d-flex gap-4">
