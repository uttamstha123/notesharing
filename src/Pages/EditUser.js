...
const EditUser = () =>{
    ...
    const getUser =async ()=>{
        let result = await fetch(`https://notesharing-backend.onrender.com/getuser/${id}`,{
            method:'post'
        });
    ...
    const update =async () =>{
        let result = await fetch(`https://notesharing-backend.onrender.com/updateuser/${id}`,{
            method:'post',
    ...
    return(
        <div className="row justify-content-center edituser-base mt-5">
            <div className='col-md-6 align-self-center edituser-main d-flex flex-column gap-3 align-items-center'>
