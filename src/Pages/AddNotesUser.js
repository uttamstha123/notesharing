...
const AddNotesUser = () =>{
    ...
    return(
        <div className='row justify-content-center addnotesuser-base mt-5'>
            <div className='col-md-6 align-self-center text-center addnotesuser-main d-flex flex-column align-items-center gap-3'>
